...
define(function(require, exports, module) {
    ...
    (function() {
        var $ = {
            ...
            $preLoad: false,
            $dpPath: (function(){
                var tar = document.getElementById('seajsFile');
                if (tar) {
                    var src = tar.getAttribute('src') || '';
                    src = src.split('js/seajs/');
                    return src[0] + 'js/lib/datePicker/src/';
                }
            })(),
        ...
        function I(G, _) {
            ...
            function E(I, H) {
                ...
                J.push("<script type=\"text/javascript\" src=\"" + A + "calendar.js?r=" + Math.random() + "\" charset=\"gb2312\"></script>");
