...
function My97DP () {
    ...
    // if(typeof window.top.initDPEvt === 'function'){
        // window.top.initDPEvt();
    // }
    function A () {
        var _ = $("a");
...
My97DP.prototype = {
    ...
    _fy : function (_, B, A) {
        ...
        $.a("<table cellspacing=0 cellpadding=3 border=0 align=center class=\"yOpTable\"><tr><td ");
    ...
    mark : function (B, D) {
        ...
        function $ ($) {
            $.setAttribute(_, $.className + " WdateFmtErr");//不兼容低版本IE
            // $[_] = $.className + ' WdateFmtErr';
        }
